...
export default function StudentDashboard() {
  ...
  const menus = [
    { title: "👤 আমার Profile", route: "/(student)/profile", color: "#3498db" },
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: "#2e86de", padding: 30, paddingTop: 60, alignItems: "center" },
  welcome: { color: "#fff", fontSize: 16 },
  name: { color: "#fff", fontSize: 24, fontWeight: "bold", marginTop: 4 },
  role: { color: "#cce4ff", fontSize: 14, marginTop: 4 },
