...
// // Deep link Stripe Checkout redirects back to. expo-web-browser's
// // openAuthSessionAsync watches for this URL and closes the in-app
// // browser automatically once it's hit.
...
//       // Give the Stripe webhook a moment to land, then refresh.
//       // We also poll the session status directly as a fallback.
